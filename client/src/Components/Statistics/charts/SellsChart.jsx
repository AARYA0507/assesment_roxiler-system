...
const SellsChart = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_BACKEND_DOMAIN}/transactions/statistics/sells`, {
                params: filters
            });
    ...
    return (
        <div className='Statistics-container boxShadow'>
            <div className='flex_center_center'>
                <h2>Sells Chart for  <span style={{ textTransform: "capitalize" }}>{filters.month}</span></h2>
            </div>
